...
--NonceCents: Below are manually-defined button regions; these are replaced by defineSBreg() with more accurate regions if that function is called

unitreg[1] = Region(5,555*aRatio,295,108*aRatio)
unitreg[2] = Region(5,664*aRatio,295,108*aRatio)
unitreg[3] = Region(5,772*aRatio,295,108*aRatio)
unitreg[4] = Region(300,555*aRatio,295,108*aRatio)
unitreg[5] = Region(300,664*aRatio,295,108*aRatio)
unitreg[6] = Region(300,772*aRatio,295,108*aRatio)
...
function chainhelpermenu(chaintable)
	...
	if (chain_mode == "All Ready Units") then
		...
		newRow()
		for u=1, 6 do
			addCheckBox("enablechain"..u, "Enable: ", true)
			addTextView("\tUnit "..u.." Ability Frame Delay: ")
			addEditNumber("chain"..u,0)
			newRow()
			addTextView("")
	...
	if (chain_mode == "All Ready Units") then
		...
		for n=1, 6 do
			if (_G["chain"..n] ~= nil and _G["enablechain"..n]) then
				chaintable[n] = _G["chain"..n]
			else
				_G["chain"..n] = nil
				chaintable[n] = nil
